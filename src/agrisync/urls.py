...
urlpatterns = [
    ...
    url(r'^account/', include('account.urls', namespace='account'), kwargs={'MAINTENANCE': 'OAUTH_APP_MAINTENANCE'}),
...
if settings.DEBUG:  # pragma: no cover
    ...
    urlpatterns += static('/favicon.ico', document_root=settings.STATICFILES_DIRS[0] + "/favicon.ico")
    urlpatterns += static('/robots.txt', document_root=settings.STATICFILES_DIRS[0] + "/robots.txt")
