...
class FarmerRegisterForm(UserCreationForm):
    ...
    dob = forms.DateField(help_text="Enter your DOB",required=False)
    ...
    income = forms.FloatField(help_text="Enter your annual Income in Lacs")
...
class ExpertRegistrationForm(UserCreationForm):
    ...
    dob = forms.DateField(help_text="Enter your DOB")
    ...
    img_file=forms.ImageField(required=True,help_text="Input your image")
